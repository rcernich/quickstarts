 ...
 * 
 */
public class AttachNotesEventBean extends ReportStatusEventBean implements AttachNotesEvent {

    private String notes;

    /**
     * Create a new AttachNotesEventBean.
     */
    public AttachNotesEventBean() {
    }

    public AttachNotesEventBean(ReportId reportId, String notes, Date timestamp) {
