...
public interface ReportSummary {
    ...
    /**
     * @return the report ID (client, destination, date)
     */
    ...
    /**
     * @return summary of the generated report; may be null
     */
    public String getSummary();

    /**
     * @return notes attached to this report, ordered as they were attached
     */
    public List<ReportNotes> getNotes();

    /**
     * @return the ordered history of the report's status
     */
